...
router.post('/admin/approve-story/:id', ensureAdmin, async (req, res) => {
  await Story.findByIdAndUpdate(req.params.id, { isApproved: true });
  res.redirect('/admin/pending-stories');
});

router.post('/admin/reject-story/:id', ensureAdmin, async (req, res) => {
